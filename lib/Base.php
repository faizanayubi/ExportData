...
/**
 * Common Functionality for Several Export Classes
 *
 * @version 1.0.0
 * @author Faizan Ayubi
 */
class Base {
    ...
    /**
     * @var bool Flag that determines whether to save file locally
     */
     ...
     */
    public function __construct($dbResult, $filename = null, $options = array()) {
